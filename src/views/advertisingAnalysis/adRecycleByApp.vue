<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="LTV30">
        <template slot-scope="scope">{{scope.row.ltv30}}</template>
      </el-table-column>
    </el-table>
...
<script>
import { findAdRecycleByApp } from "@/api/advertisingAnalysis";
...
export default {
  ...
  methods: {
    ...
    //获取数据
    //findAdRecycleByApp(appId, country, beginTime, endTime)
    fetchData(data) {
