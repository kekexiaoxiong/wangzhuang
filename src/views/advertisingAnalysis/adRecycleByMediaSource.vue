...
<script>
import { findAdRecycleByMediaSource } from "@/api/advertisingAnalysis";
...
export default {
  ...
  methods: {
    ...
    //获取数据
    //findAdRecycleByMediaSource(appId, country, dateTime)
    fetchData(data) {
      ...
      findAdRecycleByMediaSource(this.appId, this.country, this.dateTime).then(
        response => {
