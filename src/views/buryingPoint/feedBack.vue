<template>
  <div class="app-container">
    ...
    <el-table
      ...
      class="mtop"
    >
    <el-table-column align='center' label="点击CONTACT US按钮次数"  >
          <template slot-scope="scope">{{scope.row.contactUsCount}}</template>
        </el-table-column>
        <el-table-column align='center' label="游戏内反馈成功次数">
          <template slot-scope="scope">{{scope.row.feedBackSuccess}}</template>
        </el-table-column>
        <el-table-column align='center' label="游戏内反馈率" >
          <template slot-scope="scope">{{scope.row.feedBackRate}}</template>
        </el-table-column>
        <el-table-column align='center' label="登录界面点击FEEDBACK次数">
          <template slot-scope="scope">{{scope.row.loginFeedBack}}</template>
        </el-table-column>
        <el-table-column align='center' label="登录界面反馈成功次数" >
          <template slot-scope="scope">{{scope.row.loginFeedBackSuccess}}</template>
        </el-table-column>
        <el-table-column align='center' label="登录界面反馈率" >
          <template slot-scope="scope">{{scope.row.loginFeedBackRate}}</template>
        </el-table-column>
    ...
    fetchData(data) {
      ...
      findFeedbackData(
        ...
        data.endTime
         ...
         this.freeBackData = response.data;
